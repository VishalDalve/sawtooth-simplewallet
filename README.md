...
1. Install sawtooth on Ubuntu 16.04 LTS x64 machine. Refer sawtooth app developer's guide [here](https://sawtooth.hyperledger.org/docs/core/releases/latest/app_developers_guide/ubuntu.html)
2. git clone https://github.com/askmish/sawtooth-simplewallet.git
3. `cd sawtooth-simplewallet`
4. Setup the simplewallet-tp.
...
5. Setup the client. Open a new console.
